...
func main() {
	...
	labelsByMetric := map[string]string{
		...
		"SENSISION_CLASS_CONTINUUM_STANDALONE_UPDATE_DATAPOINTS_RAW":          "producer,cdn,app",
		"SENSISION_CLASS_CONTINUUM_STANDALONE_UPDATE_PARSEERRORS":             "producer",
		"SENSISION_CLASS_CONTINUUM_STANDALONE_UPDATE_REQUESTS":                "producer,cdn,app",
		"SENSISION_CLASS_CONTINUUM_STANDALONE_UPDATE_TIME_US":                 "producer,cdn,app",
